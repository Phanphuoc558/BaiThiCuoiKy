...
public class Menu {
    ...
    public static void menuSort(){
        System.out.println("Day la chuc nang sap xep theo thu tu hang hoa la: Thuc pham - Dien may - Sanh su ");
    ...
    public static void menuObjectEdit(){
        ...
        System.out.println("| 2. Sua gia nhap |");
        System.out.println("| 3. Sua ton kho  |");
