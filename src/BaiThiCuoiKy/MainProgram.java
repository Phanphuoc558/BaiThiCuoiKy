...
public class MainProgram {
    public static void main(String[] args) throws ParseException {
        ...
        list.add(new Ceramic("Chén sứ", "CR-0", (float) 0.75, 100, FormatDate.stringToDate("1/11/2021")));
        ...
        list.add(new Ceramic("Đĩa tròn", "CR-1", (float) 1, 100, FormatDate.stringToDate("1/11/2021")));
        list.add(new Food("Sweet Bread", "FD-2", (float) 0.5, 150, FormatDate.stringToDate("10/11/2021")));
        list.add(new Electric("Desktop gaming ", "EC-2", (float) 1000, 10, FormatDate.stringToDate("20/11/2021")));
        list.add(new Ceramic("Đĩa hình oval", "CR-2", (float) 1.2, 100, FormatDate.stringToDate("2/11/2021")));
        ...
        list.add(new Ceramic("Đĩa vuông", "CR-3", (float) 0.75, 100, FormatDate.stringToDate("3/11/2021")));
        ...
        list.add(new Ceramic("Tô cỡ vừa", "CR-4", (float) 1, 50, FormatDate.stringToDate("4/11/2021")));
        ...
        list.add(new Ceramic("Tô cỡ lớn", "CR-5", (float) 1.3, 50, FormatDate.stringToDate("1/11/2021")));
        ...
        list.add(new Electric("MacBook Pro M1 2020", "EC-7", (float) 1674.5, 5, FormatDate.stringToDate("19/11/2020")));
        do{
            Menu.menuMain();
